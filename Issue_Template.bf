...
_What are the Data Elements associated collected, processed, stored, or transmitted by this process?_
...
_How is the data being ingested into the GitHub environment (e.g. API Calls, User places information, User Generated/ collected etc.)?_

## Where is the data stored?
_For example: SQL Database Clusters, specific file locations, AWS S3 etc._
